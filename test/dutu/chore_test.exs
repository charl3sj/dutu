defmodule Dutu.ChoreTest do
  ...
  describe "recurs_on_date?/1" do
    ...
    test "is false for days it doesn't occur (weekly freq)" do
      ...
      # tue
      assert Chore.recurs_on_date?(every_sun_wed, ~D"2022-01-11") == false
      # thu
      assert Chore.recurs_on_date?(every_sun_wed, ~D"2022-01-13") == false
    end
    ...
    test "is true for days it occurs (weekly freq)" do
      ...
      # wed
      assert Chore.recurs_on_date?(every_sun_wed, ~D"2022-01-12") == true
      # sun
      assert Chore.recurs_on_date?(every_sun_wed, ~D"2022-01-16") == true
    end
  end
  ...
  describe "due_on_date?/1" do
    ...
    test "is true for days when it is due (daily freq)" do
      ...
      # due from 8th Jan + interval 3 = 11th __onwards__
      assert Chore.due_on_date?(every_3_days, ~D"2022-01-12") == true
      # due from 8th Jan + interval 3 = 11th __onwards__
      assert Chore.due_on_date?(every_3_days, ~D"2022-01-13") == true
    end
    ...
    test "is false for days when it isn't due (weekly freq)" do
      ...
      # tue
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-11") == false
      # thu
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-13") == false
      # mon
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-17") == false
      # fri
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-21") == false
    end
    ...
    test "is true for days when it is due (weekly freq)" do
      ...
      # past wed
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-04") == false
      # wed
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-12") == true
      # sun
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-16") == true
      # wed
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-19") == true
      # sun
      assert Chore.due_on_date?(every_sun_wed, ~D"2022-01-23") == true
    end
  end
end
