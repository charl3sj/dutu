defmodule Dutu.General.Chore do
  ...
  def recurs_every_x_days?(chore), do: chore.rrule["frequency"] == @recurrence_frequency.daily

  def recurs_every_week?(chore), do: chore.rrule["frequency"] == @recurrence_frequency.weekly

  def recurs_on_date?(chore, date) do
    last_done_at = chore.last_done_at

    if chore.rrule["frequency"] == @recurrence_frequency.daily do
      if last_done_at do
